...
public class ActionUtils {
    ...
    private static Intent getOPlusExtrasIntent(Context context) {
        Intent intent = new Intent();
        ComponentName cn=new ComponentName("org.custom.oplus.OPlusExtras",
                "org.custom.oplus.OPlusExtras.OPlusExtrasActivity");
        intent.setComponent(cn);
        return intent;
    }
    ...
    public static void triggerAction(Context context, int action) {
        ...
        if (km.isKeyguardLocked()) {
            intent = new Intent();
            intent.setClassName("org.custom.oplus.OPlusExtras", "org.custom.oplus.OPlusExtras.touch.ScreenOffLaunchGestureActivity");
